...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nr.stream-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13605&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nr.stream-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nr.stream` can be installed with:

```
conda install nr.stream
```

It is possible to list all of the versions of `nr.stream` available on your platform with:
